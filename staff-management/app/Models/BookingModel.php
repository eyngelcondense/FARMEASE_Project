...
class BookingModel extends Model
{
    ...
    protected $validationRules = [
        ...
        'start_time' => 'required',
        'end_time' => 'required',
        'total_hours' => 'required|is_natural_no_zero',
        'total_guests' => 'required|is_natural_no_zero',
        'package_id' => 'permit_empty|is_natural_no_zero',
        'venue_id' => 'permit_empty|is_natural_no_zero',
        'status' => 'permit_empty|in_list[pending,confirmed,approved,rejected,cancelled,completed]',
