<?php
$current_page = 'staff_create';
$page_title   = 'Add Staff - San Isidro Labrador Resort';
?>
        ...
        <form action="<?= site_url('staff/store') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select id="role" name="role" class="form-control" required>
                    ...
                    <option value="event_coordinator" <?= old('role') === 'event_coordinator' ? 'selected' : '' ?>>Event Coordinator</option>
