  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="nav-section">
      ...
      <ul class="nav-menu">
        ...
        <li class="nav-item">
          <a href="admin-venues-packages.php" class="nav-link">
    ...
    <nav class="nav-section">
      ...
      <ul class="nav-menu">
        <li class="nav-item">
          <a href="admin-staffs.php" class="nav-link">
  ...
  <script>
    ...
    function deleteVenue(id) {
      if (confirm('Are you sure you want to delete this venue?')) {
        ...
        // Backend will handle: DELETE FROM venues WHERE id = ${id}
      }
    }
    ...
    window.addEventListener('DOMContentLoaded', function() {
      ...
      document.querySelectorAll('.nav-link').forEach(link => {
        ...
        if (href === currentPage || (href === 'admin-venues-packages.php' && currentPage === '')) {
